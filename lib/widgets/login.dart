...
//import 'package:flutter/material/dson.dart';
...
class LoginWidget extends State<Login> {
            ...
            body: new Center(
                child: new Container(
                    ...
                    child: new Column(children: [
                      ...
                      new TextField(decoration: new InputDecoration(hintText: 'senha')),
                      new RaisedButton(
                        onPressed: () {
  ...
  void btnEntrarClicked() async {
    ...
    var request = await httpClient.get("10.20.104.20", 5000, "/v1/Uses/Authenticate");
